...
export default function HostEvent() {
  ...
  return (
    <>
      <Head>
        <title>LVAF | Host an event</title>
      </Head>
      <Navbar color="black" />
      <div className="mt-32 p-5 2xl:px-0 min-h-screen">
        ...
        <div className="mt-10 w-full text-base max-w-screen-lg mx-auto tracking-wide leading-snug">
          <div className="w-full flex flex-col md:flex-row items-start justify-between gap-10">
            ...
            <img
              ...
              src="https://firebasestorage.googleapis.com/v0/b/donation-admin-bec44.appspot.com/o/static%2Fhost-an-event%2Fimage_01.jpg?alt=media&token=2da0115a-18c9-47f3-9e16-7fcfa8c7c1f0"
              alt=""
            />
          </div>
        </div>
        ...
        <div className="w-full mt-10 mb-20 max-w-screen-lg mx-auto">
          <div className="w-full flex flex-col md:flex-row items-start justify-between gap-10">
            <img
              className="w-full h-full max-w-lg rounded-sm object-cover"
              src="https://firebasestorage.googleapis.com/v0/b/donation-admin-bec44.appspot.com/o/static%2Fhost-an-event%2Fimage_02.jpg?alt=media&token=234cd1f0-755e-40c9-96ac-b5925ad5df39"
              alt=""
            />
